...
public class UuidGenerator {
	...
	private byte[] toUuidBinary(final java.lang.String uuidStr) {
		...
		if (uuidStr.length() != UUID_STR_LEN)
			throw new java.lang.RuntimeException(
					"The length of parameter uuidStr is not " + UUID_STR_LEN);
		byte[] uuidBinary = new byte[UUID_BIN_LEN];
		for (int i = 0; i < UUID_BIN_LEN; i++)
			uuidBinary[i] = (byte) (java.lang.Short.parseShort(
	...
	private java.lang.String toUuidString(final byte[] uuidBinary) {
		if (uuidBinary == null)
			throw new java.lang.RuntimeException(
					"parameter uuidBinary is null.");
		if (uuidBinary.length != UUID_BIN_LEN)
			throw new java.lang.RuntimeException(
					"The length of parameter uuidBinary is not " + UUID_BIN_LEN);
		java.lang.StringBuffer buf = new java.lang.StringBuffer();
		for (int i = 0; i < UUID_BIN_LEN; i++) {
			java.lang.String str = java.lang.Integer
					.toHexString(uuidBinary[i] & 0x0ff);
			while (str.length() < 2)
				str = "0" + str;
	...
	private static java.lang.String genAddon() {
		...
		java.lang.String addon = java.lang.Integer.toHexString(hashToInt(bufStr
				.getBytes()));
	...
	private static void resolveMacedIpes(
			...
			java.util.Set<java.lang.String> macSet,
			java.util.Set<java.lang.String> ipSet,
			java.util.List<java.lang.Exception> exceptionHolder) {
		try {
			resolveMacedIpes(java.net.NetworkInterface.getNetworkInterfaces(),
					mapMacToIpes, exceptionHolder);
			...
			if (ipSet != null) {
				...
				for (final java.lang.String mac : macSet) {
					final java.util.Set<java.lang.String> subIpSet = mapMacToIpes
							.get(mac);
					if (subIpSet != null)
				...
				try {
					...
					if (macBytes != null && macBytes.length > 0) {
						...
						for (int i = 0; i < macBytes.length; i++)
							out.format("%02X%s", macBytes[i],
									(i < macBytes.length - 1) ? "-" : "");
						out.flush();
						java.lang.String mac = new java.lang.String(
								baos.toByteArray());
						out.close();
						baos.close();
						//
						java.util.List<java.net.InterfaceAddress> ifAddres = ni
								.getInterfaceAddresses();
						if (ifAddres != null)
							for (java.util.Iterator<java.net.InterfaceAddress> it = ifAddres
									.iterator(); it.hasNext();) {
								java.net.InterfaceAddress ifAddr = it.next();
								if (ifAddr != null) {
									java.net.InetAddress iAddr = ifAddr
											.getAddress();
									if (!iAddr.isLoopbackAddress()) {
										java.lang.String ip = iAddr
												.getHostAddress();
										//
										java.util.Set<java.lang.String> ipes = mapMacToIpes
												.get(mac);
										if (ipes == null) {
						...
						//
						resolveMacedIpes(ni.getSubInterfaces(), mapMacToIpes,
								exceptionHolder);
					}
				} catch (java.net.SocketException e) {
					if (exceptionHolder != null)
	...
	static private java.util.Map<java.lang.String, java.util.Set<java.lang.String>> mapMacToIpes = new java.util.TreeMap<java.lang.String, java.util.Set<java.lang.String>>();
	static private java.util.Set<java.lang.String> macSet = new java.util.TreeSet<java.lang.String>();
	static private java.util.Set<java.lang.String> ipSet = new java.util.TreeSet<java.lang.String>();
	static private java.util.List<java.lang.Exception> exceptions = new java.util.ArrayList<java.lang.Exception>();
	static private long procId = -1;

	static {
		try {
			resolveMacedIpes(mapMacToIpes, macSet, ipSet, exceptions);
			final java.lang.String jvmId = java.lang.management.ManagementFactory
					.getRuntimeMXBean().getName(); // format:
													// "pid@hostname"
