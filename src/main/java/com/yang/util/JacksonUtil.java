...
public final class JacksonUtil {
     ...
     *
     * <pre>
     *     {@link JacksonUtil JsonUtil}.fromJson("{\"username\":\"username\", \"password\":\"password\"}", User.class);
     * </pre>
     *
     * @param json json字符串
     * @param clazz 泛型类型
     ...
     *
     * <pre>
     *     {@link JacksonUtil JsonUtil}.fromJson("[{\"username\":\"username\", \"password\":\"password\"}, {\"username\":\"username\", \"password\":\"password\"}]", new TypeReference&lt;List&lt;User&gt;&gt;);
     * </pre>
     *
     * @param json json字符串
     ...
     *
     * <pre>
     *     {@link JacksonUtil JsonUtil}.toJson(user);
     * </pre>
     *
     * @param src 对象
     * @return 返回json字符串
     ...
     *
     * <pre>
     *     {@link JacksonUtil JsonUtil}.toJson(user, {@link Inclusion Inclusion.ALWAYS});
     * </pre>
     *
     ...
     *     {@link JacksonUtil JsonUtil}.toJson(user, mapper);
     * </pre>
     *
